...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
                 final_endpoint='Logits', name='inception_i3d', in_channels=3, dropout_keep_prob=0.5, double_BN=False, args = None):
    ...
    def forward(self, x, n_frames_segment, is_target):
        B, C, H, W = x.shape
        ...
        for end_point in self.VALID_ENDPOINTS:
            if end_point in self.end_points:
                ...
                if end_point == 'Mixed_5c':
                    feat_for_cam = x
                # if isinstance(self._modules[end_point], Unit3D):
